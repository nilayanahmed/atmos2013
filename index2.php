...
<div style="min-height:30px;
    ...
    <div class="row-fluid">
        ...
        <div class="span3 offset1">
            <p style="color:white;">
            <a class="glow" href="./campusambassador.php">Be a Campus Ambassador!</a>
			</p>
        </div>
		<div class="span2 offset1">
            <p style="color:white;">
         	<a class="glow" href="./spons.html" style="margin-left:20px;">Our Sponsors</a>
            </p>
        </div>
            <?php
				if ($loginvar=="false") {
				    echo '<div class="span3 offset1"><p style="color:white;">
                				<a class="glow" href="./contact.html">Contact Us | </a>
                				<a class="glow" href="./login.php"> Login | </a>
				    ...
				    echo '<div class="span3 offset1"><p style="color:white;">
                				<a class="glow" href="./contact.html">Contact Us | </a>
                				<a class="glow" href="./viewRegEvents.php"> My Account | </a>
...
<div class="row-fluid" id="headevents" style="background-color: rgba(0,0,0,0.1);">
	...
	<!-- ajax content will come here-->
		...
		<div class="md-content">
			<img src="./images/close.png" class="md-close" style="position:absolute;width:40px;margin-left:98%;margin-top:-18px;cursor:pointer">
...
<script type="text/javascript">
    ...
    $("#mySlider").evoSlider({
        ...
        height: 340,                        // The height of slider
			...
			$.getJSON("ajax.php",data,function(data)
				{
					...
					for(var i=0;i<data.length;i++)
					{
						str+="<a class='sidelink'><p style='margin-bottom:-20px'>"+data[i]['name']+"</a>"+"</p><hr class='linebreak'>";
						array=data;
...
<script>
$(document).on('click','#codewarssubmit',function(){
	var data = 
		{
			"handle" : $('#handle').val()
		};
		...
		{
			$('#pane5 h3').text("Handle cannot be empty..");
			$('#fadespan').text("Handle cannot be empty..");
		}
});
</script>
