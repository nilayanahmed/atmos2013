...
class FGMembersite
{
    ...
    function ValidateRegistrationSubmission()
    {
		...
		$validator->addValidation("phone","req","Please provide a contact number");
		$validator->addValidation("college","req","Please provide your college name");
	...
	function SendUserRevisedId(&$formvars)
    {
        $mailer = new PHPMailer();
    ...
    function InsertIntoDB(&$formvars)
    {
		...
		$idquery="SELECT pearl_id FROM regtable
        ...
        $insert_query = 'insert into '.$this->tablename.'(
				...
				"' . $this->SanitizeForSQL($formvars['college']) . '",
