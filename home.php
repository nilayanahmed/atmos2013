...
<div style="min-height:30px;
    ...
    <div class="row-fluid">
        ...
        <div class="span2 offset1">
            <p style="color:white;"><!--Register | Log-in | Sponsors | -->
...
<div class="row-fluid" style="margin-top:0px">
  <div class="span12">
    ...
    <dl>
      ...
      <dd id="ddt1" style="background-color:rgb(252,175,23)">
	      	...
	      	<div class="blocks" >         
	            ...
	            <img  src="./img/icons/appfest.png" ></a>
	            <p  class="blocks_desc">Appfest</p>
          	</div>
          	...
          	<div class="blocks" >            
	            ...
	            <img  src="./img/icons/bitsmun.png" ></a>
	            <p  class="blocks_desc">BITS MUN</p>
          	</div>
          
		  <div class="blocks" >            
				<a id="enigma" href="#" class="headline">
	            <img  src="./img/icons/enigma.png" ></a>
        ...
        <div class="blocks" >            
			<a id="groundreality" href="#" class="headline">
	            <img  src="./img/icons/ground_reality.png" ></a>
          ...
          <div class="blocks" >            
       	...
       	<div class="blocks" >            
			<a id="Cubing ATMOSphere" href="#" class="headline">
	            ...
	            <p  class="blocks_desc">Cubing ATMOSphere</p>
        </div>
      ...
      <dd id="ddt2" style="background-color:rgb(117,195,232)">
		  ...
		  <div class="blocks">
            ...
            <p  class="blocks_desc">Electronics</p>
          </div></a>
		  ...
		  <div class="blocks">
            <img  src="./img/icons/math.png" width="95px">
	...
	margin-right: auto;">Coming Soon!</h1>
	      	</div>
	    </div>

        <!--<a id="lectures" class="branch" href="#"><div class="blocks">
            <img  src="./img/icons/lectures.png">
            <p class="blocks_desc">Lectures</p>
          </div></a>-->
...
in experience and knowledge.</div>
		...
		<div id="footer">
			<div class="row-fluid">
				...
				<div class="span3 offset2" style="color:#ACACAC">
...
$(document).on('click','.sidelink',function()
	...
	$('#desc').click(function()
		...
		$('#register').click(function()
		{
			...
			//alert(array[index]['name']+" "+array[index]['branch']);
			//document.location.replace("register_event.php?name="+array[index]['name']+"&branch="+array[index]['branch']);
